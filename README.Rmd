...
### Intro
To grow epitaxial layers of InGaAs and InGaAsP on InP substrates, knowledge about relation between composition and bandgap/mismatch in necessary. **The company www.photin.eu developed this calculators, to help our customers, and establish common platform for discussions about material properties.  **
...
#comparison with Epitaxy project
ep=c()
#InGaAs y=1, x=from 0 to 1, with 0.1 steps
ep$eg<-modPQ_PL2Eg(c(2.2702,2.156,2.0309,1.7691,1.6623,1.5968,1.5236,1.4452,1.3643)*1000) #PL in µm to Eg in eV
ep$xrd<- -1*c(32307,25405,18503,4699,-2202,-9104,-16006,-22908,-29810)/1e6

lines(ep$xrd,ep$eg,col="brown",lwd=2)
grid()
legend("topleft",col=c("black","blue","magenta","brown","green","orange","brown"),
       lty=1,
       legend=c("x=0..1 y=1","x=0.1  y=0..1","x=0     y=0..1","x=0..1 y=0","x=0..1 y=0.7","x=0..1 y=0.9","InGaAs EpitaxyProject"),
       lwd=1.5,cex=0.9,bty="n")
 
title(xlab="Strain [absolute units]",ylab="Eg [eV]", line=2, cex.lab=1.1)
